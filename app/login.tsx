      ...
      <View className="p-6 flex-1">
        <View className="mb-4">
          ...
          <Text className="text-sm mt-4 text-gray-800">
            ...
            <Text className="text-blue-600 font-semibold hover:underline ml-1" onPress={() => Alert.alert('Register')}> Register here</Text>
          </Text>
        </View>
        ...
        <View className="mb-4">
          ...
          <View className="relative flex items-center justify-center">
            <TextInput
              ...
              autoCapitalize="none"
            />
            <Icon name="email" size={18} color="#bbb" className="absolute right-4" />
          </View>
        </View>
        ...
        <View className="mb-4">
          ...
          <View className="relative flex items-center justify-center">
            ...
            />
            <Icon name={visibilityIcon} size={18} color="#bbb" className="absolute right-4" onPress={togglePswVisibility}/>
          </View>
        </View>

        <View className="flex flex-row items-center justify-between mt-4 mb-4">
          <TouchableOpacity onPress={() => Alert.alert('Forgot Password?')}>
            <Text className="text-blue-600 font-semibold text-sm hover:underline">Forgot Password?</Text>
          </TouchableOpacity>
        </View>
        ...
        <TouchableOpacity className="w-full py-3 mt-4 rounded-md bg-blue-600 hover:bg-blue-700" onPress={handleSignIn}>
          <Text className="text-white text-sm tracking-wide text-center font-bold">Sign in</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
